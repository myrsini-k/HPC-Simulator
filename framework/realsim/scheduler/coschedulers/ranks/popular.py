...
class PopularFirstRanksCoscheduler(RandomRanksCoscheduler, ABC):

    name = "Popularity Co-Scheduler"
    ...
    def deploy(self) -> bool:
        ...
        while waiting_queue != []:
            ...
            if self.ranks[job.job_id] < 3:
                if self.allocation(job, self.cluster.full_socket_allocation):
                    deployed = True
